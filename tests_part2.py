...
class HW4Part2Tests(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.opstack_output= {
            ...
            'test33': [0, 4, 8, 12, 16, 20],
            'test34': [30, 24, 18, 12, 6, 0],
            'test35': [100],
            'test36': [StrConstant('(wPu)')],
            'test37': [1000, 100, 200, 10],
        }
    ...
    def test_input37(self):
        testinput37 = """
            /x 10 def 99 dict begin /x 100 def /y 200 def 88 dict begin /x 1000 def x end x y end x
        """ 
